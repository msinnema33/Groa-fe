...
const Dashboardv1 = props => {
  ...
  const changeHandler = e => {
    ...
    setTimeout(() => {
      setLoading(
        <h2 className="loading" style={{ paddingLeft: "5px" }}>
          .loading
        </h2>
      );
    }, 1000);
    setTimeout(() => {
      setLoading(
        <h2 className="loading" style={{ paddingLeft: "10px" }}>
          ..loading
        </h2>
      );
    }, 2000);
    setTimeout(() => {
      setLoading(
        <h2 className="loading" style={{ paddingLeft: "15px" }}>
          ...loading
        </h2>
      );
    }, 3000);
    setTimeout(() => {
      setLoading(
        <h2 className="loading" style={{ paddingLeft: "20px" }}>
          ....loading
        </h2>
      );
    }, 4000);
